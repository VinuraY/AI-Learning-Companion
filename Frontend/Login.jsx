...
const Login = () => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('http://localhost:4000/login', {  // Changed from 4000 to 4001
  ...
  return (
    <div className="min-h-screen bg-black text-white relative overflow-hidden flex items-center justify-center">
      ...
      <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-gradient-radial from-blue-600/20 to-transparent blur-3xl"></div>
      <div className="absolute bottom-1/4 left-1/4 w-96 h-96 bg-gradient-radial from-purple-600/20 to-transparent blur-3xl"></div>
      ...
      <nav className="absolute top-0 left-0 right-0 z-10 flex items-center justify-between px-8 py-6">
        ...
        <div className="flex items-center space-x-4">
          <span className="text-gray-400 hidden sm:block">Don't have an account?</span>
          <button 
            onClick={() => navigate('/signup')}
            className=" cursor-pointer text-white hover:text-gray-300 transition font-medium"
          >
            Sign Up
          </button>
        </div>
      ...
      <div className="relative z-10 w-full max-w-md px-6">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                <input
                  ...
                  className="w-4 h-4 bg-black/50 border border-gray-700 rounded focus:outline-none focus:ring-2 focus:ring-white"
                />
        ...
        <p className="text-center text-gray-400 text-sm mt-6">
          Protected by reCAPTCHA and subject to the Answerly{' '}
